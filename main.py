...
class MainView(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.statspanel.pack(side="right", fill="both", expand="True")
...
class ControlPanel(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.start_button = tk.Button(self, text="Start Training", command=self.parent.statsview.start_threshold_training)
        self.end_button = tk.Button(self, text="End Training", command=self.parent.statsview.end_threshold_training)

        self.start_button.pack(side=tk.LEFT, padx=(10, 0))
        self.end_button.pack(side=tk.RIGHT, padx=(0, 10))
